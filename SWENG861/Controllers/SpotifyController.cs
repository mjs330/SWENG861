...
namespace SWENG861.Controllers
{
    public class SpotifyController : ApiController
    {
        ...
        [HttpGet]
        public object SearchArtistTest(string id)
        {
            try
            {
                // Get and return search results in JSON
        ...
        [HttpGet]
        public object SearchTitleTest(string id)
        {
            try
            {
                // Get and return search results in JSON
        ...
        [HttpGet]
        public Paging<FullArtist> SearchArtistTestXML(string id)
        {
            try
            {
                // Get and return search results in XML
                return GetSpotifyWebAPIWithToken().SearchItemsEscaped(id, SearchType.Artist).Artists;
        ...
        [HttpGet]
        public Paging<FullTrack> SearchTitleTestXML(string id)
        {
            try
            {
                // Get and return search results in XML
                return GetSpotifyWebAPIWithToken().SearchItemsEscaped(id, SearchType.Track).Tracks;
            }
            catch (Exception Ex)
            {
                // Write error to the console
